...
#ifndef ALALBA_VK_COMMON_H
#define ALALBA_VK_COMMON_H
#include "AlalbaLog.h"
...
/**
 * check context features: layers and extensions
 * @param label               name
 ...
 */
static bool checkContextFeatures(const char* label, bool bExtension, uint32_t availableCount, void *available,
        uint32_t requestedCount, const ContextFeature *requestFeatures,
